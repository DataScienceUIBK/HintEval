...
<p align="center">
  ...
  <a href="https://colab.research.google.com/github/DataScienceUIBK/HintEval/blob/main/demo/demo.ipynb"><img src="https://img.shields.io/static/v1?label=Colab&message=Notebook&logo=Google%20Colab&color=blue"></a>
...
Generate 5 hints for each question using HintEval’s `AnswerAware` model. For this example, we will use the Meta LLaMA-3.3-70b-Instruct-Turbo model from TogetherAI.
